...
public class SimpleAuto extends SequentialCommandGroup {
        public SimpleAuto(Shooter shooter, Conveyor conveyor, Drivetrain m_robotDrive) {
                addCommands(
                                new Shoot(shooter, ShooterConstants.LOW_GOAL_AUTO_SPEED,false ).withTimeout( 2.0),
                                new ParallelCommandGroup(
                                                new Shoot(shooter, ShooterConstants.LOW_GOAL_AUTO_SPEED,false ).withTimeout( 1.0),
                                                new ConveyorUp(conveyor).withTimeout(1.0)),
                                new ParallelCommandGroup(
                                                new Shoot(shooter, -1 * ShooterConstants.HIGH_GOAL_SPEED,false ).withTimeout( 2.5),
