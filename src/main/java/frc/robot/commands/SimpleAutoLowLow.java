        ...
        addCommands(
                ...
                new ParallelCommandGroup(
                        new SequentialCommandGroup(
                                ...
                                new WarmUpShooter(shooter, ShooterConstants.LOWGOALSPEED).withTimeout(2.0)),

                        new DriveAuto(.75, m_robotDrive).withTimeout(2.25)),
                new WarmUpShooter(shooter, ShooterConstants.LOWGOALSPEED).withTimeout(.25),
                new ParallelCommandGroup(
                        new Shoot(shooter, ShooterConstants.LOWGOALSPEED).withTimeout(3.0),
